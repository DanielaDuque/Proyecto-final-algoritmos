...
MAX_LONG_POSITION_SIZE = 4.5 / TOTAL_POSITIONS
...
def make_pipeline():
    ...
    combined_factor = (
        0.9*revenue_growth_winsorized.zscore()+
        1.2*roa_winsorized.zscore()+
        1*margin_winsorized.zscore()+
        1.3*growth_score_winsorized.zscore()+
        3*gross_margin_winsorized.zscore()+
        0.2*common_stock_winsorized.zscore()
